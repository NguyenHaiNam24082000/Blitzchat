...
export default function Channel() {
  ...
  return (
    <>
      ...
      >
        <div
          className="flex w-full h-16 justify-between items-center px-2"
          style={{
        ...
        <div
          ...
          style={{
            height: event ? "calc(100% - 120px - 187px)" : "calc(100% - 120px)",
          }}
        >
          <Nav
      ...
      >
        <div className="w-full flex h-full">
          ...
          <div className="flex flex-col w-8/12 h-full flex-shrink-0 px-5">
            <Divider
              label="My Account"
              variant="dashed"
              className="font-bold"
