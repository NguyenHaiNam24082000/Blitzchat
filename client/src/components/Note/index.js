...
export default function Note() {
  ...
  return (
    ...
    >
      <div className="w-full h-12 flex items-center justify-between px-3 flex-shrink-0 bg-red-500">
        <Button
          leftIcon={
            <Image
              width={18}
      ...
      ></Selecto>
      <div
        className="editor-group w-full flex flex-col items-center overflow-y-auto pb-28 flex-shrink-0"
      ...
      >
        ...
        >
          <EditorPage id={0} fetchedBlocks={[{ tag: "p", html: "", imageUrl: "" }]} err={false}/>
        </div>
      </div>
      {/* <Dock /> */}
      <Drawer
