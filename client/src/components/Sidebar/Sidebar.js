...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="sidebar fixed top-0 left-0 h-full  m-0 flex flex-col items-center text-white overflow-y-auto overflow-x-hidden w-16">
        <img src="/logo512.png" alt="logo" className="logo my-1 mx-2 w-12 cursor-pointer" />
        <FocusRing>
          <Space
