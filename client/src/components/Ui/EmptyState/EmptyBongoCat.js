...
import './EmptyBongoCat.css';

export default function EmptyBongoCat({style}) {
    return (
        <svg style={style} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 787.3 433.8">
        <defs>
        ...
        <g id="head">
          ...
          <g id="head__face">
            <g id="eyes">
              <use width="19.2" height="18.7" transform="translate(474.8 195.2)" xlinkHref="#eye" />
              <use width="19.2" height="18.7" transform="matrix(-0.51, -0.85, 0.82, -0.5, 370.39, 192.59)" xlinkHref="#eye" />
            </g>
            <g id="mouth">
        ...
        <g id="laptop">
          ...
          <g id="paw-right">
            ...
            <g id="paw-right--up">
              ...
              <use width="31.4" height="33.93" transform="translate(273.2 166.1) rotate(-5.6)" xlinkHref="#paw-pads" />
            </g>
          </g>
            ...
            <g id="laptop__code">
              <g stroke="#3DE0E8" strokeWidth={6} transform="matrix(-1 0 0 1 278 103)">
                <g id="f3" transform="translate(0 76)">
                  <path className="typing-animation" id="f3-l9" d="M8,25L8,25" strokeDasharray="60,10" />
                  <path className="typing-animation" id="f3-l8" d="M8,13L8,13" strokeDasharray="50,10" />
                  <path className="typing-animation" id="f3-l7" d="M0,1L0,1" strokeDasharray="25,10" />
                </g>
                <g id="f2" transform="translate(0 38)">
                  <path className="typing-animation" id="f2-l6" d="M8,25L8,25" strokeDasharray="40,10" />
                  <path className="typing-animation" id="f2-l5" d="M8,13L8,13" strokeDasharray="60,10" />
                  <path className="typing-animation" id="f2-l4" d="M0,1L0,1" strokeDasharray="30,10" />
                </g>
                <g id="f1">
                  <path className="typing-animation" id="f1-l3" d="M8,25L8,25" strokeDasharray="60,10" />
                  <path className="typing-animation" id="f1-l2" d="M8,13L8,13" strokeDasharray="60,10" />
                  <path className="typing-animation" id="f1-l1" d="M0,1L0,1" strokeDasharray="60,10" />
                </g>
              </g>
            </g>
          </g>
        ...
        <g id="paw-left">
          <g id="paw-left--up">
            ...
            <use width="31.4" height="33.93" transform="matrix(0.99, -0.03, 0.04, 1, 539.85, 203.52)" xlinkHref="#paw-pads" />
          </g>
          <g id="paw-left--down">
